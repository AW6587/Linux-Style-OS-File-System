                ...
                switch(cmd) {
                    ...
                    case WAIT:
                        if ((myTcb = scheduler.getMyTcb()) != null) {
                            ...
                            return waitQueue.enqueueAndSleep(myTid); //wait tid
                    ...
                    case READ:
                        switch (param ) {
                            case STDIN:
                                try {
                                    String s = input.readLine(); // keybrd input
                                    if (s == null)
                                        return ERROR;
                                    // prepare a read buffer
                                    StringBuffer buf = (StringBuffer)args;

                                    // append input to this read buffer
                                    buf.append(s);
                    ...
                    case WRITE:
                        switch (param) {
                            case STDIN:
                                System.out.println(
                                        "threadOS: cannot write to System.in");
                                return ERROR;
                            case STDOUT:
